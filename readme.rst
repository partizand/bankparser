...
Для исполняемого файла сгенерированного pyinstaller, ini файлы могут располагаться в каталоге с программой. Такие файлы перекроют настройки из профиля пользователя.
...
pyInstaller некорректно формирует exe для 64 битных плаформ windows при исользовании upx.
